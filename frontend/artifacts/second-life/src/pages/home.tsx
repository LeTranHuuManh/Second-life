...
import { useCategories, CategoryData } from "@/hooks/use-categories";
          ...
          <div className="container mx-auto px-4 z-10">
            <div className="max-w-xl space-y-6">
              ...
              <p className="text-lg md:text-xl text-slate-700/80 font-medium">
                Khám phá hàng ngàn món đồ Second-hand chất lượng cao. Mua hoặc
                thuê - Lựa chọn là của bạn!
              </p>
              <div className="flex gap-4 pt-2">
                <Link href="/tim-kiem">
                  <Button
                    size="lg"
                    className="rounded-full shadow-colored font-bold text-base px-8 h-12"
                  >
                    Khám phá ngay
                  </Button>
                </Link>
                <Link href="/quan-ly">
                  <Button
                    variant="outline"
                    size="lg"
                    className="rounded-full font-bold text-base px-8 h-12 bg-white/80 backdrop-blur hover:bg-white"
                  >
                    Đăng tin
                  </Button>
                </Link>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="flex flex-col items-center text-center gap-4 bg-white p-6 rounded-3xl shadow-sm border border-border/50">
              ...
              <p className="text-sm text-muted-foreground">
                Thanh toán được đảm bảo 100% qua hệ thống Second Life.
              </p>
            </div>
            <div className="flex flex-col items-center text-center gap-4 bg-white p-6 rounded-3xl shadow-sm border border-border/50">
              <div className="w-12 h-12 rounded-full bg-primary/10 text-primary flex items-center justify-center">
              ...
              <p className="text-sm text-muted-foreground">
                Kéo dài tuổi thọ sản phẩm, giảm rác thải ra môi trường.
              </p>
            </div>
            <div className="flex flex-col items-center text-center gap-4 bg-white p-6 rounded-3xl shadow-sm border border-border/50">
              <div className="w-12 h-12 rounded-full bg-primary/10 text-primary flex items-center justify-center">
              ...
              <p className="text-sm text-muted-foreground">
                Chỉ cần thuê những gì bạn muốn, dùng trong bao lâu tùy thích.
              </p>
            </div>
            <div className="flex flex-col items-center text-center gap-4 bg-white p-6 rounded-3xl shadow-sm border border-border/50">
              <div className="w-12 h-12 rounded-full bg-primary/10 text-primary flex items-center justify-center">
              ...
              <p className="text-sm text-muted-foreground">
                Hỗ trợ vận chuyển nhanh chóng, tiết kiệm chi phí.
              </p>
            </div>
          </div>
        </div>
